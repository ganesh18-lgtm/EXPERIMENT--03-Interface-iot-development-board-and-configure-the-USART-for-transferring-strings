...
int main(void)
{
  ...
  {
    /* USER CODE END WHILE */
	  printf("Name: Ganesh B C\n");
	  printf("Reg No: 212225040090\n");
...
## Output screen shots of Serial port utility   :
 ...
 <img width="1600" height="851" alt="WhatsApp Image 2026-08-20 at 10 55 14 AM" src="https://github.com/user-attachments/assets/ae626bc9-ad1d-4417-9120-05d9139a00b7" />
